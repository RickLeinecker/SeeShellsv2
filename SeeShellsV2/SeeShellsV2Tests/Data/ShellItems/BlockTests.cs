...
namespace SeeShellsV2.Data.Tests
{
    ...
    public class BlockTests
    {
        ...
        public void UnpackByteTest()
        {
            ...
            for (var i = 0; i < b.Length; i++)
                Assert.IsTrue(Block.UnpackByte(buf, i) == b[i]);
        }
        ...
        public void UnpackWordTest()
        {
            ...
            for (var i = 0; i < b.Length; i++)
                Assert.IsTrue(Block.UnpackWord(buf, i*2) == b[i]);
        }
        ...
        public void UnpackGuidTest()
        {
            ...
            Assert.IsTrue(Block.UnpackGuid(buf, 0) == "20d04fe0-3aea-1069-a2d8-08002b30309d");
        }
        ...
        public void UnpackWStringTest()
        {
            ...
            for (var i = 0; i < s.Length; i++)
            {
                ...
                Assert.IsTrue(Block.UnpackWString(buf, offset) == s[i]);
        ...
        public void UnpackStringTest()
        {
            ...
            {
                Assert.IsTrue(s[i].Length == i);
                Assert.IsTrue(Block.UnpackString(buf, offset) == s[i]);
                offset += s[i].Length + 1;
            }
        }
        ...
        public void UnpackDWordTest()
        {
            ...
            for (var i = 0; i < b.Length; i++)
                Assert.IsTrue(Block.UnpackDWord(buf, i * 4) == b[i]);
        }
        ...
        public void UnpackQwordTest()
        {
            ...
            for (var i = 0; i < b.Length; i++)
                Assert.IsTrue(Block.UnpackQWord(buf, i * 8) == b[i]);
        }
        ...
        public void UnpackDosDateTimeTest()
        {
            ...
            Assert.IsTrue(Block.UnpackDosDateTime(buf, 0) == new DateTime(1980, 5, 10, 21, 21, 20));
        }
        ...
        public void UnpackFileTimeTest()
        {
            ...
            Assert.IsTrue(Block.UnpackFileTime(buf, 1) == new DateTime(636202939949621621, DateTimeKind.Utc).ToLocalTime());
        }
    }
}