...
namespace SeeShellsV2.Data.Tests
{
    ...
    public class RegistryKeyWrapperTests
    {
        ...
        public void RegistryKeyWrapperTest3()
        {
            ...
            Assert.IsTrue(rkWrapper.LastRegistryWriteDate == new DateTime(637300198697461019, DateTimeKind.Utc));
            ...
            Assert.IsTrue(rkWrapper.SlotModifiedDate == new DateTime(637300198698554500, DateTimeKind.Utc));
